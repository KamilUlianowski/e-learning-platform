...
intellisense.annotate(jQuery, {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="MyContext" type="Element">DOM element to serve as the MyContext in which the HTML fragment will be created</param>
  ...
  'proxy': function() {
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular MyContext.</summary>
    ///   <param name="function" type="Function">The function whose MyContext will be changed.</param>
    ///   <param name="MyContext" type="PlainObject">The object to which the MyContext (this) of the function should be set.</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular MyContext.</summary>
    ///   <param name="MyContext" type="PlainObject">The object to which the MyContext of the function should be set.</param>
    ///   <param name="name" type="String">The name of the function whose MyContext will be changed (should be a property of the MyContext object).</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular MyContext.</summary>
...
intellisense.annotate(_object, {
  ...
  'fireWith': function() {
    /// <signature>
    ///   <summary>Call all callbacks in a list with the given MyContext and arguments.</summary>
    ///   <param name="MyContext" type="">A reference to the MyContext in which the callbacks in the list should be fired.</param>
...
intellisense.annotate(_object, {
  ...
  'notifyWith': function() {
    /// <signature>
    ///   <summary>Call the progressCallbacks on a Deferred object with the given MyContext and args.</summary>
    ///   <param name="MyContext" type="Object">MyContext passed to the progressCallbacks as the this object.</param>
    ///   <param name="args" type="Object">Optional arguments that are passed to the progressCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  ...
  'rejectWith': function() {
    /// <signature>
    ///   <summary>Reject a Deferred object and call any failCallbacks with the given MyContext and args.</summary>
    ///   <param name="MyContext" type="Object">MyContext passed to the failCallbacks as the this object.</param>
  ...
  'resolveWith': function() {
    /// <signature>
    ///   <summary>Resolve a Deferred object and call any doneCallbacks with the given MyContext and args.</summary>
    ///   <param name="MyContext" type="Object">MyContext passed to the doneCallbacks as the this object.</param>
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    ...
    ///   <summary>Add elements to the set of matched elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of matched elements.</param>
    ///   <param name="MyContext" type="Element">The point in the document at which the selector should begin matching; similar to the MyContext argument of the $(selector, MyContext) method.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'addBack': function() {
  ...
  'closest': function() {
    ...
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <param name="MyContext" type="Element">A DOM element within which a matching element may be found. If no MyContext is passed in then the MyContext of the jQuery set will be used instead.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
  ...
  'context': function() {
    /// <summary>The DOM node MyContext originally passed to jQuery(); if none was passed then MyContext will likely be the document.</summary>
    /// <returns type="Element" />
  },
  'css': function() {
    /// <signature>
  ...
  'init': function() {
    ...
    ///   <param name="MyContext" type="jQuery">A DOM Element, Document, or jQuery to use as MyContext</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
